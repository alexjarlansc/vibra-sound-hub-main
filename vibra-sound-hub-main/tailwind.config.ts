	...
	theme: {
		...
		extend: {
			colors: {
				...
				'music-player': 'hsl(var(--music-player-bg))',
				'music-card': {
					'1': 'hsl(var(--music-card-1))',
					'2': 'hsl(var(--music-card-2))',
					'3': 'hsl(var(--music-card-3))',
					'4': 'hsl(var(--music-card-4))',
					'5': 'hsl(var(--music-card-5))',
					'6': 'hsl(var(--music-card-6))'
				},
				secondary: {
